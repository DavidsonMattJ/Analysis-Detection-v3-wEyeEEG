...
% this script calculates and aggregates the change in accuracy / RT etc
% relative to saccade onset (as a comparison to gait-cycle position).
% creates a figure we may use as a SF.
